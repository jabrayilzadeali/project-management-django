...
SECRET_KEY = 'django-insecure-q0^1%yolt*)94!*=pzotj$459acl&$pes@dj_15tw(!ghr3@#%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['project-management-django4.herokuapp.com', '127.0.0.1']
